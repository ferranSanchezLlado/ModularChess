...
class TestQueen(BaseTestPieces):
    ...
    def test_check_move(self):
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("a6")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("a4")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("a2")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("c8")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("c1")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("g8")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("f1")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("h4")))
        self.assertIsEmpty(self.piece1.check_piece_valid_move(Position("d6")))
        self.assertIsEmpty(self.piece1.check_piece_valid_move(Position("g1")))

        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("a5")))
        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("a1")))
        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("b8")))
        ...
        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("h8")))
        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("h5")))
        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("h2")))
        self.assertIsEmpty(self.piece2.check_piece_valid_move(Position("h1")))
        self.assertIsEmpty(self.piece2.check_piece_valid_move(Position("c4")))
    ...
    def test_capture(self):
        ...
        self.assertIsEmpty(self.piece1.check_piece_valid_move(Position("c6")))
        ...
        self.assertIsEmpty(self.piece2.check_piece_valid_move(Position("b5")))
