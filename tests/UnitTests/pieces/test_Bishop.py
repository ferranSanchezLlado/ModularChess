...
class TestBishop(BaseTestPieces):
    ...
    def test_check_move(self):
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("a7")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("a1")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("h8")))
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("g1")))
        self.assertIsEmpty(self.piece1.check_piece_valid_move(Position("a8")))
        self.assertIsEmpty(self.piece1.check_piece_valid_move(Position("e4")))

        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("f5")))
        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("f3")))
        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("d5")))
        self.assertIsNotEmpty(self.piece2.check_piece_valid_move(Position("d3")))
        self.assertIsEmpty(self.piece2.check_piece_valid_move(Position("e5")))
        self.assertIsEmpty(self.piece2.check_piece_valid_move(Position("e8")))
    ...
    def test_capture(self):
        ...
        self.assertIsEmpty(self.piece2.check_piece_valid_move(Position("a8")))
    ...
    def test_piece_in_path(self):
        ...
        self.assertIsNotEmpty(self.piece1.check_piece_valid_move(Position("c5")))
