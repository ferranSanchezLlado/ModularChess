...
class TestPromotion(unittest.TestCase):
    ...
    def test_movements(self):
        ...
        self.assertTupleEqual((MovementData(self.pawn, self.pawn_position, None),
        ...
        self.assertTupleEqual((MovementData(self.enemy_piece, self.enemy_piece_position, None),
