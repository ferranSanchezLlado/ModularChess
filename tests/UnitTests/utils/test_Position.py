...
class TestPosition(unittest.TestCase):
    ...
    def test_not_int(self):
        self.assertRaises(InvalidArgumentsError, Position, coord=["a", "b", "c"])
        self.assertRaises(InvalidArgumentsError, Position, coord=[1.1, 1.2, 1.3])
        self.assertRaises(InvalidArgumentsError, Position, coord=["a", 1, 2])
