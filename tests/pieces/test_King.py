...
class TestKing(BaseTestPieces):
    ...
    def test_check_move(self):
        self.assertIsNotEmpty(self.king.check_move(Position("d1")))
        self.assertIsNotEmpty(self.king.check_move(Position("d2")))
        self.assertIsNotEmpty(self.king.check_move(Position("e2")))
        self.assertIsNotEmpty(self.king.check_move(Position("f1")))
        self.assertIsNotEmpty(self.king.check_move(Position("f2")))
        self.assertIsNotEmpty(self.king.check_move(Position("a1")))
        self.assertIsNotEmpty(self.king.check_move(Position("h1")))
        self.assertIsEmpty(self.king.check_move(Position("e3")))
        self.assertIsEmpty(self.king.check_move(Position("a2")))
    ...
    def test_king_in_castling_check(self):
        ...
        self.assertIsEmpty(self.king.check_move(Position("h1")))
        self.assertIsEmpty(self.king.check_move(Position("g1")))
        self.assertIsNotEmpty(self.king.check_move(Position("a1")))
    ...
    def test_piece_in_path(self):
        ...
        self.assertIsEmpty(self.king.check_move(Position("a1")))
        self.assertIsEmpty(self.king.check_move(Position("c1")))
        self.assertIsNotEmpty(self.king.check_move(Position("h1")))
