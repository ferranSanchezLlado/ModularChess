...
class TestQueen(BaseTestPieces):
    ...
    def test_check_move(self):
        ...
        self.assertIsNotEmpty(self.piece1.check_move(Position("d1")))
        self.assertIsNotEmpty(self.piece1.check_move(Position("d8")))
        self.assertIsNotEmpty(self.piece1.check_move(Position("h4")))
        self.assertIsEmpty(self.piece1.check_move(Position("a1")))
        self.assertIsEmpty(self.piece1.check_move(Position("e5")))
        ...
        self.assertIsEmpty(self.piece2.check_move(Position("h8")))
        self.assertIsEmpty(self.piece2.check_move(Position("a6")))
    ...
    def test_capture(self):
        ...
        self.assertIsEmpty(self.piece1.check_move(Position("d7")))
