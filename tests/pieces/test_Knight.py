...
class TestKnight(BaseTestPieces):
    ...
    def test_check_move(self):
        ...
        self.assertIsNotEmpty(self.piece1.check_move(Position("c6")))
        self.assertIsNotEmpty(self.piece1.check_move(Position("e2")))
        self.assertIsNotEmpty(self.piece1.check_move(Position("f5")))
        self.assertIsEmpty(self.piece1.check_move(Position("b6")))
        self.assertIsEmpty(self.piece1.check_move(Position("d1")))

        self.assertIsNotEmpty(self.piece2.check_move(Position("c5")))
        self.assertIsNotEmpty(self.piece2.check_move(Position("d2")))
        self.assertIsNotEmpty(self.piece2.check_move(Position("f6")))
        self.assertIsNotEmpty(self.piece2.check_move(Position("g3")))
        self.assertIsEmpty(self.piece2.check_move(Position("h1")))
        self.assertIsEmpty(self.piece2.check_move(Position("c7")))
